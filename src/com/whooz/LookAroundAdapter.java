...
public class LookAroundAdapter extends ArrayAdapter<WhoozEvent> {

	private Context context;
	private ArrayList<WhoozEvent> events;

	public LookAroundAdapter(Context context, int resource,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = inflater.inflate(R.layout.look_around_item, parent,false);
			...
			public void onClick(View v) {
				...
				q.getInBackground(events.get(position).getObjectId(), new GetCallback<ParseObject>() {
					...
					public void done(ParseObject arg0, ParseException arg1) {
						...
						LookAroundAdapter.this.notifyDataSetChanged();
					}
				});
			}
		});
