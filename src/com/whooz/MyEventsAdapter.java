...
public class MyEventsAdapter extends ArrayAdapter<WhoozEvent> {

	private Context context;
	private ArrayList<WhoozEvent> events;

	public MyEventsAdapter(Context context, int resource,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = inflater.inflate(R.layout.user_created_events_item, parent,false);
